...
<div class="uk-margin-small uk-grid-small" uk-grid>
    ...
    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="summary">
            体験のサマリ<small class="uk-text-danger">※「自分で予約型」の場合は必須</small>
        </label>
        <div class="uk-form-controls">
            <textarea class="uk-textarea uk-height-small" name="summary">{{old('summary', isset($content) ? $content->summary: null )}}</textarea>
        </div>
    </div>
    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="reserve_way">
            予約方法<small class="uk-text-danger">※「自分で予約型」「TODOROKIで予約型」の場合は必須</small>
        </label>
        <div class="uk-form-controls">
            <textarea class="uk-textarea uk-height-small" name="reserve_way">{{old('reserve_way', isset($content) ? $content->reserve_way: null )}}</textarea>
        </div>
    </div>
    ...
    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="address">
            コンテンツを実施する住所<small class="uk-text-danger">※「自分で予約型」「TODOROKIで予約型」の場合は必須</small>
        </label>
        <div class="uk-form-controls">
            <input class="uk-input" type="text" name="address" value="{{old('address', isset($content) ? $content->address: null )}}">
        </div>
    </div>
    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="access">
            アクセス方法<small class="uk-text-danger">※「自分で予約型」「TODOROKIで予約型」の場合は必須</small>
        </label>
        <div class="uk-form-controls">
            <textarea class="uk-textarea uk-height-small" name="access">{{old('access', isset($content) ? $content->access: null )}}</textarea>
        </div>
    </div>
...
<div class="uk-margin-small uk-grid-small" uk-grid>
    ...
    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="length">
            所要時間<small class="uk-text-danger">※「自分で予約型」「TODOROKIで予約型」の場合は必須</small>
        </label>
        <div class="uk-form-controls">
            <input class="uk-input" type="text" name="length" value="{{old('length', isset($content) ? $content->length: null )}}">
        </div>
    </div>

    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="tools">
            必要なもの<small class="uk-text-danger">※「自分で予約型」「TODOROKIで予約型」の場合は必須</small>
        </label>
        <div class="uk-form-controls">
            <input class="uk-input" type="text" name="tools" value="{{old('tools', isset($content) ? $content->tools: null )}}">
        </div>
    </div>

    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="tel">
            電話番号<small class="uk-text-danger">※「自分で予約型」の場合、電話番号もしくはメールアドレスのどちらかが必須</small>
        </label>
        <div class="uk-form-controls">
    ...
    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="email">
            メールアドレス <small class="uk-text-danger">※「自分で予約型」の場合、電話番号もしくはメールアドレスのどちらかが必須</small>
        </label>
        <div class="uk-form-controls">
    ...
    <div class="uk-width-1-2@s">
        <label class="uk-form-label" for="link_url">
            詳細ページへのリンクURL<small class="uk-text-danger">※「自分で予約型」「TODOROKIで予約型」の場合は必須</small>
        </label>
        <div class="uk-form-controls">
            <input class="uk-input" type="text" name="link_url" value="{{old('link_url', isset($content) ? $content->link_url: null )}}">
        </div>
    </div>
